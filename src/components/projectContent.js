...
export const foreverMeDescription = () => {
               ...
               <p>The ability to pull product data from the existing Shopify store and upload it en-mass to
               ...
               of both PHP,SQL and Open Cart its self. I spent 80 hours studying the Open Cart source code and completely cut
               ...
               <p>The front end requests are made using fetch and the ansychronicity of the
                ...
                <p>index.php?route=/api/shipping/methods&api_token=343sdd44454</p>
...
export const symbolSmithDescription = () => (
               <div className='ssDescription'>
                   ...
                   <div> 
                         ...
                         of British and Irish antique silver via the symbols impressed on it. The App makes use of the iphones camera and allows users to save their
...
export const budgetAppDescription = () => (
            <div>
               ...
               <div>The App gives the user the ability to add, edit and remove expense. Users can also
...
/*<p>Please Note: As my employer has not yet uploaded his entire inventory; this website is functional but in demo mode. Purchases
               are sent to the PayPal sandbox API.
               I worked on this project alone. This was my first time working with React. I had only a very
                basic knowledge with PHP and none with a large MVC framework like Open Cart. It was an excellent
                learning experience and having no technical superior taught me to be creative in my problem 
                solving and self reliant.
               </p>
               <p>The new codes generates a user token to allow customer tracking and access to Open Cart API functions</p>
               <p>Organising and tracking my work was very important to me and so I set up a Trello board and
               time tracked every task from the inception of the project. You can visit my Trello link and 
               even sort by kind of task (i.e front-end, back-end, PHP, CSS, resolving a bug, planning and research).
               </p>
               ...
               <p>
               An easy payment process. The previous website had a laborious payment process whereby many
               personal details had to be rentered. The new payment process saves and remembers details such as address, name and email
               and automatically enters the billing address as shipping address as default. All payment details are then forwarded to 
               PayPal via the API which for security purposes handle the card payment details.
               </p>
               <p>
               Integration with the PayPal API that involved alteration of the PHP opencart code
               </p>
               ...
               <p>Automa</p>
                 <p>Picture of MVC Chart</p>
                 <p>
               The site is fully functional however my employer has not yet migrated his inventory over due to the time involved and 
               an already functioning Shopify store which I also set up and managed.
               </p>
                 <p>
               I also managed the advertising of the store across google ads, running multiple campaigns and
               ensuring that they most cost effective keywords and bidding prices were used. Our ads were consistently
               the number one google search result for Bath Bombs; our primary product.
               </p>
               ...
               <p>css animations</p>
               <div>You can visit the GitHub link and view commit history to see the changes made to the OpenCart backend. 
               Notable file/folders are Upload which contains php files handling all of the requests coming from the front end and
               connects them with PHP functions (previously existing, modified or created) in the back end). Only files that were added,
               modified or demonstrate understanding of the backend have been uploaded.
               </div>
               <div>Brief</div>*/